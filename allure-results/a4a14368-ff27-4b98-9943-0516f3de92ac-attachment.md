...
- Name: searchItems.test.js >> Search Items Test >> Search items from JSON file
- Location: tests\searchItems.test.js:29:7

# Error details

```
TypeError: Cannot read properties of undefined (reading 'readJsonFile')
```
