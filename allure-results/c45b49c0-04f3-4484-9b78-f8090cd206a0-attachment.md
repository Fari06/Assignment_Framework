      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]:
            ...
            - textbox "Username:" [ref=e12]: newuser
          - generic [ref=e13]:
...
```ts
  ...
  7  |   await signup.signUp('newuser', 'password123');
  8  |   const alertText = await page.evaluate(() => window.alertText);
> 9  |   expect(alertText).toContain('Sign up successful');
     |                     ^ Error: expect(received).toContain(expected) // indexOf
  10 | });
```